...
<template>
    <main className="h-screen px-10 py-16 grid grid-rows-">
        ...
        <div className="flex text-center w-full place-content-center text-xl">
            Die Print-Version ist die klassische physische Zeitung. Ihr_e Verkäufer_in wird Ihnen diese nach Abschluss des
            Kaufes aushändigen.
        </div>
        <div className="flex place-items-center w-full">
            <RouterLink to="/print-digital">
