...
<template>
  <component :is="$route.meta.layout || 'div'">
    <template #main>
      <div class="h-full grid grid-rows-5 place-items-center">
        <div class="text-center font-semibold text-3xl">Ausgabe wählen</div>
        ...
        <div class="grid place-items-center row-span-2 w-full">
          <RouterLink class="grid place-items-center" to="/information">
            <button
              class="bg-green-600 rounded-full w-[76px] h-[76px] text-white text-4xl font font-semibold mx-auto"
            >
              ?
            </button>
          </RouterLink>
